...
*/
pessoa.nomeCompleto(); // Olá! Meu nome é Erick Simões!
...
// Agora, apresente-se ;)
pessoa.apresentacao() //Olá, eu sou o Erick Simões, tenho 27 anos, 1.87, meu peso é 86 e, só hoje, eu já caminhei 6 metros!
```
