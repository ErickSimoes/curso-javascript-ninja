...
*/
carro.adicionarPessoa = function (nPessoas) {
    if (carro.quantidadePessoas === carro.assentos && nPessoas >= 0) {
        return 'O carro já está lotado!';
    }
    if (nPessoas + carro.quantidadePessoas > carro.assentos) {
        var quantasCabem = carro.assentos - carro.quantidadePessoas;
        var pessoas = quantasCabem === 1 ? ' pessoa!' : ' pessoas!';
        return 'Só cabem mais ' + (quantasCabem) + pessoas;
    }
